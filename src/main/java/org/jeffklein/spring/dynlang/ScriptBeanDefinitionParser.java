...
/*
 * HACK ALERT (jklein 9/12/2013): This is a direct copy from the spring source
 * code of org.springframework.scripting.config.ScriptBeanDefinitionParser
 * I had to copy the source code because the "real" class is not
 * public and cannot be used outside of its own package. LAME!
 */
